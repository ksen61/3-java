...
public class Main {//объявление класса Main
    ...
    public static void main(String[] args) {// обьявляем метод main, который запускает программу
        ...
        if (a <= 0 || b <= 0 || c <= 0) {// проверка на то, что хотя бы одно число отрицательное или равно нулю, если условие выполняется, то выводится
            // сообщение об ошибке, что стороны  стороны треугольника должны быть положительными числами
            System.out.println("Ошибка: стороны треугольника должны быть положительными числами.");
        } else if (a * a + b * b == c * c || b * b + c * c == a * a || c * c + a * a == b * b) { // проверка, являются ли стороны тругольника a, b и с
            // сторонами прямоугольного треугольника, если условие выполняется, то выводится сообщение, что стороны образуют прямоугольный треугольник
            System.out.println(a + ", " + b + " и " + c + " являются сторонами прямоугольного треугольника");
        } else if (a == b && b == c) {// проверка, являются ли стороны тругольника a, b и с сторонами равностороннего треугольника, если условие
        ...
        } else if (a == b || b == c || c == a) {// проверка, являются ли стороны тругольника a, b и с сторонами равнобедренного треугольника, если условие
        ...
        } else if (!(a + b > c && b + c > a && c + a > b)) {// проверка, не являются ли стороны тругольника a, b и с сторонами треугольника, если условие
            // выполняется, то выводится сообщение, что стороны не образуют треугольник
            System.out.println(a + ", " + b + " и " + c + " не являются сторонами треугольника");
        } else {// если все предыдущие условие не были выполнены, то выводится сообщение, что стороны образуют обычный треугольник
